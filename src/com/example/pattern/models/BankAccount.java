...
public class BankAccount {
    ...
    public BankAccount(String accountName, String accountNumber, String address, String email, boolean newsletter, boolean mobileBanking) {
        super();
    ...
    public String toString() {
        return "BankAccount [name=" + accountName + ", accountNumber=" + accountNumber + ", address=" + address + ", email="
